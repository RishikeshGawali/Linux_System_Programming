...
{
    printf("Thread 1 is created with Thread id : %ld\n",(pthread_t*)pthread_self());
}

void* ThreadProc2(void* ptr)
{
    printf("Thread 2 is created with Thread id : %ld\n",(pthread_t*)pthread_self());
}

void* ThreadProc3(void* ptr)
{
    printf("Thread 3 is created with Thread id : %ld\n",(pthread_t*)pthread_self());
}

void* ThreadProc4(void* ptr)
{
    printf("Thread 4 is created with Thread id : %ld\n",(pthread_t*)pthread_self());
}
